...
master
  ...
  .to( prod1, 0.5, { scale: 0.94, x: 168, y: 19, rotate: 25, ease: Expo.easeOut }, '+=1')
  .to( prod2, 0.5, { scale: 0, opacity: 0, rotate: -31, ease: Expo.easeOut }, '-=0.5')
  .to( prod3, 0.5, { scale: 0.95, x: 191, y: 7, rotate: 24, ease: Expo.easeOut }, '-=0.5')
  .to( prod4, 0.5, { scale: 0.95, x: -88, y: 16, rotate: -15, ease: Expo.easeOut }, '-=0.5')
  .to( prod5, 0.5, { scale: 0, opacity: 0, rotate: 17, ease: Expo.easeOut }, '-=0.5')
  ...
  .from( cta, 0.5, { y: 25, opacity: 0, ease: Back.easeOut }, '-=0.45')
  .from( scLogo, 0.5, { opacity: 0, scale: 0, ease: Expo.easeOut }, '-=0.35')
