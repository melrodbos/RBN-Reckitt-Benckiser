...
master
  ...
  .from( [ head1, head2], 0.75, { y: 50, scale: 0.5, stagger: 0.05, opacity: 0, ease: Expo.easeOut, force3D: false }, '-=0.5')
  ...
  .to( prodWrap, 0.5, { y: 85, ease: Back.easeOut }, '+=0.5')

  .from( label, 0.5, { scale: 0.5, x: 150, y: -150, ease: Expo.easeOut, force3D: false }, '-=0.25')
  ...
  .from( scLogo, 0.5, { opacity: 0, scaleX: 0.5, transformOrigin: 'center', ease: Back.easeOut, force3D: false }, '-=0.25')
